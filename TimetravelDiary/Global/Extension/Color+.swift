...
extension Diary {
    enum color {
        ...
        static let timeTravelGreenColor = Color(UIColor(hexCode: "15B392"))
        static let timeTravelDarkGrayColor = Color(UIColor(hexCode: "373A40"))
        static let timeTravelPopUpColor = Color(UIColor(hexCode: "151515"))
